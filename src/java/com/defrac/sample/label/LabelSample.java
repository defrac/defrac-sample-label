...
class LabelSample extends Screen {
    ...
    displayList.onStageReady(stage -> {
      ...
      resources.listener(new ResourceGroup.SimpleListener<Object>() {
        ...
        public void onResourceGroupComplete(ResourceGroup<Object> group, List<Object> content) {
          ...
          onResourcesComplete(stage, alphaFont, copyPixelFont, signedDistanceFieldFont);
        }
      });
  ...
  void onResourcesComplete(Stage stage,
    ...
    // dynamically sized
    final Quad quad = new Quad(256.0f, 256.0f, 0xff602020);

    // Finally create our labels
    final Label alphaFontLabel = new Label();
    final Label copyPixelLabel = new Label();
    final Label sdfLabel = new Label();
    final Label dynamicLabel = new Label();

    stage.
        addChild(quad).
        addChild(alphaFontLabel).
        addChild(copyPixelLabel).
        addChild(sdfLabel).
    ...
    stage.globalEvents().onPointerDown.add(event -> {
